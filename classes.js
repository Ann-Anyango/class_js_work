...
// false, false to true)
class Car1{
    constructor(make,model,year,isAvilable){
        this.make=make
        this.model=model
        this.year=year
    ...
    toggleAvailablity(){
        this.isAvilable=!this.isAvilable()
    }

}
let  car = new Car1("Toyota", "Camry", 2020, true);
console.log(car); 
...
let rentals1=new Rental("car object","Ann",20,30)
console.log(rentals1)
...
let new_rentals=new Car("car object","Ann",20,30)
console.log(new_rentals);
class Rental1{
...
let final=new Rental1("Car objects","Ann",23,34)
console.log(final)
...
class Quiz{
    constructor(quations,currentQuestionIndex,score){
    this.quations=[]
